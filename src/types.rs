...
pub type GetMultiWindowAttrib = ffi::rk_aiq_uapiV2_wb_awb_mulWindow_t;
pub type AutoWbGain = ffi::rk_aiq_uapiV2_wb_awb_wbGainOffset_t;
pub type AutoWbAttrib = ffi::rk_aiq_wb_querry_info_t;

pub type CprocAttrib = ffi::acp_attrib_t;
...
pub type Sync = ffi:: rk_aiq_uapi_sync_t;
...
impl From<ffi::rk_aiq_wb_mwb_mode_t> for MWBalanceMode {
    fn from(val: ffi::rk_aiq_wb_mwb_mode_t) -> Self {
        use ffi::rk_aiq_wb_mwb_mode_t::*;
        match val {
			//RK_AIQ_MWB_MODE_INVAILD RK_AIQ_MWB_MODE_CCT RK_AIQ_MWB_MODE_WBGAIN RK_AIQ_MWB_MODE_SCENE 
			
            RK_AIQ_MWB_MODE_INVAILD => MWBalanceMode::ModeInvalid,
            RK_AIQ_MWB_MODE_CCT => MWBalanceMode::ModeCct,
            RK_AIQ_MWB_MODE_WBGAIN => MWBalanceMode::ModeWbgain,
            RK_AIQ_MWB_MODE_SCENE => MWBalanceMode::ModeScene,
        }
    }
}

impl From<MWBalanceMode> for ffi::rk_aiq_wb_mwb_mode_t {
    fn from(val: MWBalanceMode) -> Self {
        use ffi::rk_aiq_wb_mwb_mode_t::*;
        match val {
			
            MWBalanceMode::ModeInvalid => RK_AIQ_MWB_MODE_INVAILD,
            MWBalanceMode::ModeCct => RK_AIQ_MWB_MODE_CCT,
            MWBalanceMode::ModeWbgain => RK_AIQ_MWB_MODE_WBGAIN,
            MWBalanceMode::ModeScene => RK_AIQ_MWB_MODE_SCENE,
